...
categories: "java基础复习"
top: 11
tags: [java复习,面试,多线程,网络编程,Socket,tcp/ip]
---
...
**B/S结构** ：全称为Browser/Server结构，是指浏览器和服务器结构。常见浏览器有谷歌、火狐等。<!-- more -->
